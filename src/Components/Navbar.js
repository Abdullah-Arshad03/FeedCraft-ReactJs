    ...
    <div className="navbar flex  justify-between bg-[#f5e8de] h-14 drop-shadow-md" >
      <div className="flex justify-start">
        <h1 onClick={()=> navigate('/')} className=" cursor-pointer hover:text-[#114B5F]  ml-4 mt-3 heading font-mono font-semibold text-2xl"    style={{
           ...
           {feed ? (<>
  <p className="ml-4 mt-3"><a  className=" cursor-pointer hover:text-[#114B5F]  ml-4  heading font-mono font-semibold text-2xl"  style={{
    fontFamily: "'Poiret One', sans-serif"}} href="/profile">Feed</a></p>
    <p className="mr-2 mt-3"><a  className=" cursor-pointer hover:text-[#114B5F]  ml-4  heading font-mono font-semibold text-2xl"  style={{
    fontFamily: "'Poiret One', sans-serif"}} href="/profile">Profile</a></p></>
) : (
  <></>
)}
</div>
